...
- Stage: H3/R8 extension and readable-HUD overlay rerender complete
- Next action: commit the explicitly staged non-video final state, then wait for
  the user's next decision
- Active workers or audits: none
- Worktree: `/home/ariel/Documents/COSC594/badminton_cv_annotator`, branch `investigation/serve-id-by-lookback-followup`, actual tip `24ac3a4`
