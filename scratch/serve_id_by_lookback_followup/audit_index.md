...
| Final causal audit | `claude-opus-4-6-thinking` | Compact evidence and proposed conclusion | Pending | Not run | Required before report finalisation |
| Final causal audit | `gemini-3.1-pro-high`, high | Compact evidence and proposed conclusion | Pending | Not run | Required before report finalisation |
