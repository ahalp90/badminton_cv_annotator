...
The useful changes are a local insertion score inside the combined chooser and guarded section-edge extensions. The edge rule changes no contact timestamps, raw sides or event membership; most of the rally gain is better containment. Net recovery improves in 38 videos, ties in eight and loses one rally in one video at ±10. Settings were chosen on development data, and the broader predictions were saved before loading evaluation labels. These videos have been examined before.
