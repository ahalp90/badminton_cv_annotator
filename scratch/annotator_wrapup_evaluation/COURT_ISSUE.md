...
Two court errors are making the annotator miss usable play. The pictures below show
...
![Video 53: numbered neural-net corners before and after OpenCV fallback.](https://raw.githubusercontent.com/ahalp90/badminton_cv_annotator/investigation/annotator-failures/scratch/annotator_wrapup_evaluation/figures/video53_nn_to_opencv.png)
...
shared outline from accepted scenes across the video. That outline is too small for this view, and the player picker loses
...
![Video 17: numbered neural-net corners replaced by an undersized shared outline.](https://raw.githubusercontent.com/ahalp90/badminton_cv_annotator/investigation/annotator-failures/scratch/annotator_wrapup_evaluation/figures/video17_nn_to_shared.png)
...
0.02 pixels. Corner 1
still falls below the confidence threshold. The right panel uses the saved OpenCV fallback
outline.
