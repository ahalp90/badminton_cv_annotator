...
**Bottom line.** The result: neither change is a safe replacement for the baseline on these nine views, and each makes at least one view worse. The midpoint anchor (M) turns GX5 from an outright failure into a court 9.9 working pixels from its approved control (baseline 525.7) and improves both Amateur-2 views, but it wrecks GX0 (7.7 to 379.3) and Amateur-3 (8.5 to 23.8). The precise representative (R) clearly improves only Amateur-2 frame 28019 and ShuttleSet 03 scene 17, and loses GX0, Amateur-3 and ShuttleSet 21; on Amateur-3 (8.5 to 58.2) its directions produce no court within 44 pixels. For M, where it wins or loses in the matcher trial (E4) agrees with its control-fit potential (E3) on seven of nine views; R's mostly sub-pixel E3 gains do not carry through. The rescoring stages rescue nothing, and the all-camera paint winner fails badly in four of the 27 case-arms.
...
- **M against B (paint winner):** better on GX5 (525.7 to 9.9), Am2-150 (12.4 to 8.8), Am2-28019 (none to 7.0) and SS03-16 (3.9 to 3.3). Worse on GX0 (7.7 to 379.3), Am3-0 (8.5 to 23.8) and SS03-17 (7.6 to 8.4). Same on SS03-19 and SS21-20. The direction of change agrees with E3 on seven views; SS03-16 moves the opposite way, and SS03-19 sits within 0.03 pixels under both.
- **R against B (paint winner):** better on Am2-28019 (none to 6.1) and SS03-17 (7.6 to 6.9), and by under 0.15 pixels on SS03-19 and SS03-16. Worse on GX0 (7.7 to 13.3), Am3-0 (8.5 to 58.2), SS21-20 (2.0 to 2.8) and, by 0.2 pixels, Am2-150. GX5 fails under both. R's line winner beats B's on GX0 (16.5 to 10.4) and SS03-17 (8.4 to 6.9). E3 had R better on seven views, mostly by under a pixel; only Am2-28019 and SS03-17 carry through, and both E3 regressions (Am3-0, SS21-20) appear, with GX0 added.
...
A pooled court can sit closer to the control than the E3 fit (GX5 M, Am2-28019 M), because the matcher refines axes per pair and the E3 fit minimises a different quantity, so the two columns are not a nested bound. The large availability losses are M on GX0 (19.7 to 33.8), M on Am3-0 (4.2 to 20.5) and R on Am3-0 (4.3 to 44.2).

Filtering: the nearest pooled court survives the camera bound and the global cap into the generation-stage final set in 21 of 27 case-arms. The six exceptions:

| Case-arm | Nearest pooled | Nearest camera-eligible pooled | Nearest final (generation) |
| --- | ---: | ---: | ---: |
| GX0 M | 33.8 | 34.6 | 314.3 |
| GX0 R | 8.7 | 8.7 | 10.1 |
| GX5 B | 23.7 | 89.9 | 460.5 |
| GX5 R | 22.8 | 89.3 | 355.8 |
| Am2-28019 B | 15.3 | 16.0 | 82.8 |
| Am3-0 R | 44.2 | 55.4 | 58.0 |

On GX5 the camera bound removes every court within 24 pixels for B and R, while M's 9.8-pixel court passes it.
...
**Rescoring stages.** Camera-first rescoring changed no winner's error except on the views that were already failing (GX0 M, GX5 B and R), on Am3-0 R (paint 58.2 to 74.3), and on Am2-28019 B, which gains its first winners there (145.1 and 17.2). The all-camera stage keeps every camera-eligible pooled court (724 to 3,265 entries). Its line winners equal the camera-first line winners in all 27 case-arms. Its paint winner moved far from the control in four case-arms, and shifted between failing values on GX0 M and GX5 B:
...
| GX5 R | 448.1 | 2,237.9 | 2,216 | The floor gate passes no entry on GX0, GX5 or Am2-28019 in any arm or stage, as in the baseline; it passes 3 to 145 entries on the other six views.

## Negative findings

- M regresses GX0 (paint 7.7 to 379.3; no pooled court within 33 pixels), Am3-0 (8.5 to 23.8) and SS03-17 (7.6 to 8.4).
- R regresses GX0 (7.7 to 13.3), Am3-0 (8.5 to 58.2; no pooled court within 44 pixels) and SS21-20 (2.0 to 2.8), and leaves GX5 failing (378.5).
- E3's small R gains (under a pixel on five views) do not reach the winners on GX0, GX5 or Am2-150.
- The line ranking selects a court about 140 pixels from the control on both Amateur-2 views under every arm that has a winner there.
- The all-camera paint winner is hundreds to thousands of pixels off in four of 27 case-arms, including the baseline on SS03-19 and Am2-28019.
...
E4 generation is the expensive part. Seconds per case-arm, single-threaded, four processes running at once on an otherwise idle 32-core host (B from the earlier baseline run under three concurrent groups):
...
- Why does M's GX0 pool hold no court within 33 pixels of the control when B's holds one at 7.7? E2 shows two of M's 16 directions more than 10 degrees from any B direction; whether the pair that produced B's court lost a direction under M can be checked from the E2 records and the pair provenance of candidate 22:4588.
...
- The all-camera paint ranking fails on four case-arms with pools above 1,300 courts. Whether the paint score degrades with pool size or those pools contain a specific wrong-court family is untested.
