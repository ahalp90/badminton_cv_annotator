...
cap_loss copy: EXPERIMENT_DIR points at cap_loss so run_dir and code_md5 describe this folder.
The E2 records this copy reads still live under direction_agreement/runs/<run>/e2.
