...
def main() -> None:
    ...
    parser.add_argument('--run', required=True, help='cap_loss_<UTC timestamp> or pregate_<UTC timestamp>')
    ...
    assert args.run.startswith(('cap_loss_', 'pregate_')), args.run
    ...
    print('run_given from', run_automatic.run_given.__file__, flush=True)
