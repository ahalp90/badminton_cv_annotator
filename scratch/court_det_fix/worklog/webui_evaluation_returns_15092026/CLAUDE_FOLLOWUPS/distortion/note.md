...
Gate: the broadcast control's median absolute sagitta is not small compared with GX's, so this test does not establish a validated GX-specific distortion measurement or an upper bound. The observed bow is consistent with ordinary line-fragment fitting noise rather than a demonstrated systematic barrel or pincushion effect. Further distortion work is deferred for priority reasons, not because the explanation has been disproved. No fix is proposed here.
