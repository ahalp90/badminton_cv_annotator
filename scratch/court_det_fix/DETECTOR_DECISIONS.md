...
| D14 | Colour measurements reveal useful contradictions and limitations, not a demonstrated detector improvement. The Am1 fragment probe reproduces tape/paint separation; its positive controls and independent reference markings are insufficient for a general veto. A wrong GX5 court can follow genuine same-colour paint. Raw paint and adjacent-floor colour must stay separate; missing evidence is not rejection. | [Colour diagnostic and corrections](colour_consistency/PLAN.md) |
| D15 | The user expects colour work, then one final new WebUI net-evidence lead, followed by a coherent pragmatic deployable detector. Keep older ideas as reference rather than reopening an indefinite research queue. The new packet has been located but its proposals have not been assessed locally. | [Resume and scope](pickup.md); [new packet](webui_net_evidence_frontier_handover/README.md) |

### Interpret the colour gallery correctly
