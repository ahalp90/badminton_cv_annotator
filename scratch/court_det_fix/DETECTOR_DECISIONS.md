...
| D15 | The old net scorer penalises missing evidence and remains unsuitable unchanged. The earlier no-go concerned the old proposal pool. New automatic line-group seeds plus a fixed positive net-support preference give a promising Am1 result; visual review and combined-change regression checks remain before integration. | [Net assessment](NET_EVIDENCE_ASSESSMENT.md); [recovery result](colour_consistency/AM1_RECOVERY.md) |
