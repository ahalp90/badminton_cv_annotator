...
| D15 | The old net scorer penalises missing evidence and remains unsuitable unchanged. The earlier no-go concerned the old proposal pool. New automatic line-group seeds plus a fixed positive net-support preference give an Am1 result the user accepts despite a remaining inset to the inner edge of the right yellow stripe. Combined-change regression checks remain before integration. | [Net assessment](NET_EVIDENCE_ASSESSMENT.md); [recovery result](colour_consistency/AM1_RECOVERY.md) |
