...
| D03 | Midpoint and representative changes each caused regressions. Fixed-membership SVD is diagnostic, not a tested matcher improvement. SVD search reduction remains a deployment lead; graph search should follow a settled search design. A 12-family screen preserves the best cached reference-fit pair on nine development views; automatic-candidate retention and speedup remain untested. | [Direction search](evidence/direction_search/README.md); [SVD assessment](evidence/webui_followup3_20260922/ASSESSMENT.md) |
