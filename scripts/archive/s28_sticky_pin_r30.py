"""Library-only acceptance pins for the sticky-anchor contact gate, base-30 era.

Succeeds s28_sticky_pin.py (kept byte-frozen as the P record): same body, md5s and output
dir updated after the fps constants flipped to base-30 integers. See the README succession
note, including why the r9 arm no longer matches the H yardstick record.
"""
...
OUTPUT_DIR = HERE / 's28_sticky_pin_r30_outputs'
EXPECTED_MD5 = {
    9: {'pilot': 'd4f60a1a31c9284ea9cc70f6929618c8',
        'vid15': '117920c2d07679a29569da354119003a'},
    7: {'pilot': '684e0c107fd33d8fd1e53d883f9cfa5e',
        'vid15': '304c09f52ddad6cbd8a07bc6b22d2f30'},
}
