...
A companion producer to stage9_replay_mask: a second way to build the same
...
Run as `python -m scraper.stage9_composition_mask --video-id ... --video <288p>
