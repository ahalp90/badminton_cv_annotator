...
def build_dead_mask(
    ...
    *,
    ...
    if mode is DeadMaskMode.REPLAY:
        return combine_mask(court_present, homography_rows, track, rally_spans, n_frames, fps)
    ...
    replay = combine_mask(court_present, homography_rows, track, rally_spans, n_frames, fps)
