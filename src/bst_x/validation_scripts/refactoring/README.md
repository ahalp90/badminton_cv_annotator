...
| `smoke_prepare_2d_bit_exact.py` | `prepare_train_on_shuttleset.prepare_dataset_npy_from_raw_video` lift | ~30-60 min on HPC | venv-mmpose | Pose-extraction path; bit-compares per-stem clean output between two branches |
