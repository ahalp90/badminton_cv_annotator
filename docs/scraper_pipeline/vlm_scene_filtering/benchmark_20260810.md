...
| Qwen3-VL 30B-A3B FP8 | vLLM 0.11.0 | Model load and cache sizing | 40,656 MiB | 200.46 s | Full context cannot fit |
...
- Runtime code revision:
  `155f418af61dfce6571f27a5783570e16a044e8a`.
- Model loading used 30.3924 GiB and took 31.68 seconds.
...
a maximum supported length of 68,832 tokens on this L40.
...
- [Qwen stable capacity record](data/benchmark_20260810/qwen3-vl-stable-capacity-run.json.gz),
  uncompressed SHA-256
  `02be2f33f93fdc5407c5a6a6467114726a4fcd09c85e683763e2b38f687e5530`.
...
- [Qwen stable capacity log](data/benchmark_20260810/qwen3-vl-stable-capacity.log.gz),
  uncompressed SHA-256
  `a7d37bd09312daaa98112e64206f2a8feeaa158d8ff9ff605e8af5c8c4479165`.
