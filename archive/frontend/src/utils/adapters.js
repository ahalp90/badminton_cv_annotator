...
const ARCH_NOTES = {
  'bst-x': 'Skeleton keypoint and shuttle trajectory transformer. No pre-training. Built on BST-CG-AP. Adds: player detection, CDB-F1 loss, scheduling and augmentations. 1.85M trainable parameters, fed by a frozen perception stack (RTMPose-L pose, RTMDet-M detector, TrackNetV3 shuttle; ~64M params).',
